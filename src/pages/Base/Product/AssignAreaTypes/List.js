...
import { CustomModal, SelectTemplateUnitOp } from "../../../../components";
        ...
        <Box sx={{ flexGrow: 1, paddingX: 3 }}>
            <Grid display="flex" alignItems="center" container spacing={2}>
                ...
                <CustomModal
                    ...
                    content={
                        <SelectTemplateUnitOp
                            data={product}
                            onCloseModal={handleCloseModal}
                            screen={"AssignAreaTypes"}
                            route={"/base/product-mpr/assign-area-types"}
                        />
                    }
                    width={650}
                    height={680}
...
export default AssignATypeList;